...
class TreeAdapter() : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
    ...
    private var selectedPos = androidx.recyclerview.widget.RecyclerView.NO_POSITION
    ...
    inner class TreePreviewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView), View.OnClickListener {
    ...
    fun updateViewSelectedState(position: Int = androidx.recyclerview.widget.RecyclerView.NO_POSITION) {
