package com.mallzhub.customer.ui.profile_signin
...
import com.mallzhub.customer.databinding.ProfileSignInBinding
import com.mallzhub.customer.ui.LoginHandlerCallback
            ...
            takePictureIntent.resolveActivity(mContext.packageManager)?.also {
                ...
                photoFile?.also {
                    val photoURI: Uri = FileProvider.getUriForFile(
                        mContext,
                        "com.mallzhub.customer.fileprovider",
                        it
                    )
